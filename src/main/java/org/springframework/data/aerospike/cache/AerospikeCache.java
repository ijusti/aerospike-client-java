...
public class AerospikeCache implements Cache {
    ...
    /**
     * Return the value (bins) from the Aerospike database to which this cache maps the specified key, obtaining that
     * value from valueLoader if necessary. This method provides a simple substitute for the conventional "if cached,
    ...
    /**
     * Return the value (bins) from the Aerospike database to which this cache maps the specified key. Generically
     * specifying a type that return value will be cast to.
     *
     * @param key  The key whose associated value (bins) is to be returned.
     * @param type The required type of the returned value (can be null to bypass a type check; in case of a null value
     *             found in the cache, the specified type is irrelevant).
    ...
    /**
     * Returns the value (bins) from the Aerospike database to which this cache maps the specified key. Returns null if
     * the cache contains no mapping for this key; otherwise, the cached value (which may be null itself) will be
     * returned in a Cache.ValueWrapper.
     *
     * @param key The key whose associated value (bins) is to be returned.
     * @return The value (bins) to which this cache maps the specified key, contained within a Cache.ValueWrapper which
    ...
    public ValueWrapper putIfAbsent(Object key, Object value) {
        ...
        // Key doesn't exist, write the new given key-value to Aerospike database and return null
