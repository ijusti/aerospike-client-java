...
public class PersonTestData {
    ...
    public static final Person leroi2 = Person.builder().id(nextId()).firstName("Leroi").lastName("Moore").age(25)
    ...
    public static class Indexed {
        ...
        public static final IndexedPerson dave = IndexedPerson.from(PersonTestData.dave);
        public static final IndexedPerson donny = IndexedPerson.from(PersonTestData.donny);
        public static final IndexedPerson oliver = IndexedPerson.from(PersonTestData.oliver);
        public static final IndexedPerson carter = IndexedPerson.from(PersonTestData.carter);
        public static final IndexedPerson boyd = IndexedPerson.from(PersonTestData.boyd);
        public static final IndexedPerson stefan = IndexedPerson.from(PersonTestData.stefan);
        public static final IndexedPerson leroi = IndexedPerson.from(PersonTestData.leroi);
        public static final IndexedPerson leroi2 = IndexedPerson.from(PersonTestData.leroi2);
        public static final IndexedPerson alicia = IndexedPerson.from(PersonTestData.alicia);

        public static final List<IndexedPerson> all = Arrays.asList(oliver, dave, donny, carter, boyd, stefan, leroi,
            leroi2, alicia);
    }
}
